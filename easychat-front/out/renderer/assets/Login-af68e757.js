import { g as getAugmentedNamespace, c as commonjsGlobal, a as getDefaultExportFromCjs, _ as _export_sfc, b as getCurrentInstance, u as useRouter, d as useUserInfoStore, r as ref, o as onMounted, e as onUnmounted, f as resolveComponent, h as openBlock, i as createElementBlock, j as createBaseVNode, t as toDisplayString, k as createVNode, w as withCtx, l as withModifiers, F as Fragment, m as createBlock, n as renderList, p as createCommentVNode, q as withKeys, s as createTextVNode, v as pushScopeId, x as popScopeId, y as nextTick } from "./index-347654a5.js";
...
const Login_vue_vue_type_style_index_0_scoped_6a5deefd_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-6a5deefd"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "login-panel" };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "title drag" }, "G-Chat", -1));
const _hoisted_3 = {
  key: 0,
  class: "loading-panel"
};
...
const _hoisted_8 = { class: "email-panel" };
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "iconfont icon-email" }, null, -1));
const _hoisted_10 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "iconfont icon-down" }, null, -1));
const _hoisted_11 = ["onClick"];
const _hoisted_12 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "iconfont icon-user-nick" }, null, -1));
const _hoisted_13 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "iconfont icon-password" }, null, -1));
const _hoisted_14 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "iconfont icon-password" }, null, -1));
const _hoisted_15 = { class: "check-code-panel" };
const _hoisted_16 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "iconfont icon-checkcode" }, null, -1));
const _hoisted_17 = ["src"];
const _hoisted_18 = { class: "bottom-link" };
const _sfc_main = {
  __name: "Login",
  setup(__props) {
              ...
              default: withCtx(() => [
                createVNode(_component_el_form_item, { prop: "email" }, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_8, [
                      ...
                      isLogin.value && localUserList.value.length > 0 ? (openBlock(), createBlock(_component_el_dropdown, {
                        key: 0,
                        trigger: "click",
                        "max-height": "200"
                      }, {
                        dropdown: withCtx(() => [
                          createVNode(_component_el_dropdown_menu, null, {
                            default: withCtx(() => [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(localUserList.value, (item) => {
                                return openBlock(), createBlock(_component_el_dropdown_item, null, {
                                  default: withCtx(() => [
                                    createBaseVNode("div", {
                                      class: "email-select",
                                      onClick: ($event) => selectEmail(item.email)
                                    }, toDisplayString(item.email), 9, _hoisted_11)
                                  ]),
                                  _: 2
                                }, 1024);
                              }), 256))
                ...
                createVNode(_component_el_form_item, null, {
                  default: withCtx(() => [
                    createVNode(_component_el_button, {
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(isLogin.value ? "登录" : "注册"), 1)
                      ]),
                      _: 1
                    })
                  ]),
                ...
                createBaseVNode("div", _hoisted_18, [
                  createBaseVNode("span", {
                    class: "a-link no-account",
                    onClick: changeOpType
                  }, toDisplayString(isLogin.value ? "没有账号?" : "已有账号?"), 1)
                ])
              ]),
              _: 1
            }, 8, ["model"])
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6a5deefd"]]);
export {
  Login as default
};
