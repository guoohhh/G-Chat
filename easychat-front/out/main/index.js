...
const addUserSetting = async (userId2, email) => {
  ...
  const sysSetting = {
    localFileFolder: userDir + "\\.G_chat\\fileStorage\\"
  };
...
const openWindow = ({ windowId, title = "G-Chat", path: path2, width = 960, height = 720, data }) => {
